    ...
    @foreach($blogPosts as $blogPost)
        <section class="post">
            <header class="entry-header">
                ...
                <p class="entry-meta">Posted on {{ $blogPost->date }} :: <i class="fa fa-comment"></i> <a href="@url($blogPost->path)#disqus_thread" data-disqus-identifier="{{ str_replace('/','-',ltrim($blogPost->path, '/')) }}">No comments</a></p>
            </header>
